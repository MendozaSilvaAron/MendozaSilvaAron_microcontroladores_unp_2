...
FINAL_IMAGE=${DISTDIR}/P1_C.Leds.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=C.Leds.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/C.Leds.o
POSSIBLE_DEPFILES=${OBJECTDIR}/C.Leds.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/C.Leds.o

# Source Files
SOURCEFILES=C.Leds.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/P1_C.Leds.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/P1_C.Leds.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/C.Leds.o: C.Leds.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/C.Leds.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/C.Leds.o \
	C.Leds.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/P1_C.Leds.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q84 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/P1_C.Leds.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
