...
FINAL_IMAGE=${DISTDIR}/P2_D.7seg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=D.7seg.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/D.7seg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/D.7seg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/D.7seg.o

# Source Files
SOURCEFILES=D.7seg.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/P2_D.7seg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/P2_D.7seg.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/D.7seg.o: D.7seg.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/D.7seg.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/D.7seg.o \
	D.7seg.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/P2_D.7seg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q84 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/P2_D.7seg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
